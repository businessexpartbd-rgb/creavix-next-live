...
export default function CtaBand() {
  return (
    <section className="container-x py-20 sm:py-24">
      <Reveal>
        <div className="relative overflow-hidden rounded-card border border-on-dark/10 bg-gradient-to-br from-ink-800 via-ink-900 to-ink-950 p-8 shadow-card sm:p-12 lg:p-16">
          <div className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-accent-primary/30 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-accent-primary/15 blur-3xl" />

          <div className="relative grid gap-10 lg:grid-cols-[1.3fr_1fr] lg:items-center">
            <div>
              <span className="eyebrow">Ready to launch · যোগাযোগ</span>
              <h2 className="mt-5 font-display text-3xl uppercase tracking-[0.04em] text-on-dark sm:text-4xl lg:text-5xl">
              ...
              <p className="mt-3 max-w-xl font-bn text-sm leading-7 text-muted">
